#ifndef __doc_agc_compare_rectifier_and_square_law_cgxe_h__
#define __doc_agc_compare_rectifier_and_square_law_cgxe_h__
...
extern unsigned int
  cgxe_doc_agc_compare_rectifier_and_square_law_method_dispatcher(SimStruct* S,
  int_T method, void* data);
extern int cgxe_doc_agc_compare_rectifier_and_square_law_autoInfer_dispatcher(
  const mxArray* prhs, mxArray* lhs[], const char* commandName);
extern void cgxe_doc_agc_compare_rectifier_and_square_law_initializer(void);
extern void cgxe_doc_agc_compare_rectifier_and_square_law_terminator(void);
